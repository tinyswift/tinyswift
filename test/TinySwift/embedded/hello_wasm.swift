// RUN: %target-swift-frontend -emit-ir -target wasm32-unknown-wasi \
...
// WebAssembly WASI demo: writes "Hello, TinySwift!" via putchar from support.c.
// Uses @_silgen_name to call C helper for WASI fd_write.
