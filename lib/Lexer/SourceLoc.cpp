...
llvm::Optional<unsigned> SourceManager::getIDForBufferIdentifier(
        llvm::StringRef BufIdentifier) {
...
llvm::StringRef SourceManager::extractText(CharSourceRange Range,
    ...
    llvm::StringRef Buffer = LLVMSourceMgr.getMemoryBuffer(*BufferID)->getBuffer();
