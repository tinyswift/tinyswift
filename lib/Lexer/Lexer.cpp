...
void Lexer::lexIdentifier() {
    ...
    tok Kind = kindOfIdentifier(llvm::StringRef(TokStart, CurPtr - TokStart), InSILMode);
...
unsigned Lexer::lexCharacter(const char *&CurPtr, char StopQuote,
    ...
    switch (*CurPtr) {
        default:  // Invalid escape.
            ...
            if (clang::isAlphanumeric(*CurPtr)) ++CurPtr;
            return ~1U;
...
llvm::StringRef Lexer::getEncodedStringSegment(llvm::StringRef Bytes,
...
SourceLoc Lexer::getLocForStartOfToken(SourceManager &SM, SourceLoc Loc) {
    llvm::Optional<unsigned> BufferIdOp = SM.getIDForBufferIdentifier(SM.
