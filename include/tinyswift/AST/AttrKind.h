...
#ifndef TINYSWIFT_ATTRKIND_H
#define TINYSWIFT_ATTRKIND_H
...
enum class InlineKind : uint8_t { Never = 0, Always = 1 };
...
/// so please do not reorder existing values.
enum class EffectsKind : uint8_t { ReadNone, ReadOnly, ReadWrite, Unspecified };

enum DeclAttrKind : unsigned {
#define DECL_ATTR(_, NAME, ...) DAK_##NAME,
#include "tinyswift/AST/Attr.def"
  DAK_Count
};
