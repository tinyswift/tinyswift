...
#ifndef TINYSWIFT_SOURCEMANAGER_H
#define TINYSWIFT_SOURCEMANAGER_H
...
public:
  ...
  unsigned getHashbangBufferID() const { return HashbangBufferID; }
  ...
  ///
  /// \sa closeVirtualFile.
  bool openVirtualFile(SourceLoc loc, llvm::StringRef name, int lineOffset);
  ...
  getIDForBufferIdentifier(llvm::StringRef BufIdentifier);
  ...
  llvm::StringRef
  extractText(CharSourceRange Range,
...
#endif // TINYSWIFT_SOURCEMANAGER_H
