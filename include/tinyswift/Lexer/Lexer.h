...
public:
  ...
  void restoreState(State S, bool enableDiagnostics = false) {
    ...
    llvm::SaveAndRestore<DiagnosticEngine *> D(
        Diags, enableDiagnostics ? Diags : nullptr);
    lexImpl();
  }
  ...
  /// source location.
  static llvm::StringRef getIndentationForLine(SourceManager &SM,
                                               SourceLoc Loc);
  ...
  getEncodedStringSegment(llvm::StringRef Str,
                          llvm::SmallVectorImpl<char> &Buffer);

  llvm::StringRef
  getEncodedStringSegment(StringSegment Segment,
                          llvm::SmallVectorImpl<char> &Buffer) const {
    return getEncodedStringSegment(
        llvm::StringRef(getBufferPtrForSourceLoc(Segment.Loc), Segment.Length),
        Buffer);
  }
...
private:
  ...
  llvm::StringRef getSubstring(const char *Start, unsigned Length) const {
